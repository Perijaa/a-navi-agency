...
export const experiences: Experience[] = [
  {
    ...
    image: assetPath("/images/legacy/glass-boat/glass-boat-hero.jpg"),
    detailImage: assetPath("/images/legacy/glass-boat/glass-boat-canyon.jpg"),
    tag: "Most Popular",
    highlights: [
  ...
  },
  {
    ...
    image: assetPath("/images/legacy/taxi-boat/taxi-boat-2.jpg"),
    detailImage: assetPath("/images/legacy/taxi-boat/taxi-boat-hero.jpg"),
    tag: "Scenic",
    highlights: [
  ...
  },
  {
    ...
    image: assetPath("/images/legacy/rent-a-boat/rent-boat-hero.jpg"),
    detailImage: assetPath("/images/legacy/rent-a-boat/rent-boat-2.jpg"),
    tag: "Freedom",
    highlights: [
  ...
  },
  {
    ...
    priceFrom: 14,
    currency: "EUR",
    pricing: [{ label: "Per person", price: "From \u20ac14" }],
    benefits: [
    ...
    image: assetPath("/images/legacy/semi-submarine/semi-sub-hero.jpg"),
    detailImage: assetPath("/images/legacy/semi-submarine/semi-sub-1.jpg"),
    tag: "Underwater",
    highlights: [
  ...
  },
  {
    ...
    priceFrom: 35,
    currency: "EUR",
    pricing: [{ label: "Per person", price: "\u20ac35" }],
    benefits: [
    ...
    image: assetPath("/images/legacy/rafting/rafting-1.jpg"),
    detailImage: assetPath("/images/legacy/rafting/rafting-2.jpg"),
    tag: "Adventure",
    highlights: [
  ...
  },
  {
    ...
    currency: "EUR",
    pricing: [
      { label: "Adults", price: "\u20ac12" },
      { label: "Children 5\u201313", price: "\u20ac8" },
      { label: "Under 5", price: "Free" },
    ],
    benefits: [
...
export const gallery: GalleryItem[] = [
  {
    id: "g1",
    image: assetPath("/images/legacy/taxi-boat/taxi-boat-hero.jpg"),
    alt: "Radmanove Mlinice on the Cetina River",
    caption: "The Cetina gorge near Omi\u0161 — best experienced by boat through the canyon.",
  ...
  },
  {
    id: "g2",
    image: assetPath("/images/legacy/glass-boat/glass-boat-hero.jpg"),
    alt: "Glass boat on the Cetina in Omi\u0161",
    caption: "Waters so clear the Cetina riverbed feels close enough to touch.",
    location: "Cetina River, Glass Boat",
    span: "tall",
  },
  {
    id: "g3",
    image: assetPath("/images/legacy/rafting/rafting-3.jpg"),
  ...
  {
    id: "g4",
    image: assetPath("/images/legacy/taxi-boat/taxi-boat-3.jpg"),
    alt: "Taxi boat on the Cetina",
  ...
  {
    id: "g5",
    image: assetPath("/images/legacy/taxi-boat/radmanove-mlinice.jpg"),
    alt: "Radmanove Mlinice taxi boat tour",
    caption: "A centuries-old mill estate hidden where the Cetina canyon is narrowest.",
  ...
  },
  {
    ...
    location: "Cetina Canyon, Night Ride",
    span: "normal",
  },
  {
    id: "g7",
    image: assetPath("/images/legacy/semi-submarine/semi-sub-4.jpg"),
    alt: "Semi submarine off the Omi\u0161 coast",
    caption: "Panoramic underwater windows into the Adriatic ecosystem.",
    location: "Omi\u0161 Coast, Semi Submarine",
    span: "normal",
  },
];
